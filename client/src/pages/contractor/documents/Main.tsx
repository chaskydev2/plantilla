...
import { getAttributeContractorsByUser } from '@/core/services/contractor/contractor.service';
...
import AttributeContractorModal from './Form';
...
const AttributeContractor: React.FC = () => {
  ...
  const fetchData = async () => {
    ...
    try {
      ...
      const response = await getAttributeContractorsByUser(userId);
      ...
      console.error('Error fetching attribute contractors:', error);
      setItems([]);
    } finally {
      setLoading(false);
    }
...
export default AttributeContractor;
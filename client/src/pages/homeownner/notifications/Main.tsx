...
const mockNotifications: NotificationItem[] = [
  {
    ...
    message: "Electricistas Norte envió una cotización para tu proyecto Instalación de luminarias.",
    status: "unread",
    category: "booking",
  ...
  },
  {
    ...
    message: "Tu depósito para Jardines Vivos se registró con éxito.",
    status: "read",
    category: "payment",
  ...
  },
  {
    ...
    message: "Revisa las nuevas recomendaciones para proteger tu cuenta.",
    status: "read",
    category: "security",
  ...
  },
  {
    ...
    message: "ConstruMar SRL visitará tu domicilio el jueves 19 a las 10:00.",
    status: "unread",
    category: "booking",
      ...
      <div className="space-y-3 px-6 py-5 text-sm text-gray-600">
        ...
        {notification.category === "security" && (
          <div className="flex items-center gap-2 rounded-xl bg-gray-50 px-4 py-3 text-xs text-gray-600">
            ...
            Recomendamos activar la verificación en dos pasos para mantener tu cuenta protegida.
          </div>
        )}
      </div>
    </div>
